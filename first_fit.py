...
#Processo alocado em first fit
def aloca_first_fit(nome_processo, tam_processo, lista_memoria):
    idx = 0
...
def main():
    ...
    inicia_buddy(1024) #1024KB é 1G
    print("\n lista 1: ", lista_memoria)
    
    aloca_first_fit("P1", 70, lista_memoria)
    print("\n lista 2: ", lista_memoria)
    
    aloca_first_fit("P2", 35,lista_memoria)    
    print("\n lista 4: ", lista_memoria)

    aloca_first_fit("P3", 80,lista_memoria)    
    print("\n lista 5: ", lista_memoria)
    
    desaloca("P1", lista_memoria) 
    print("\n lista 6: ", lista_memoria)      
    
    aloca_first_fit("P4", 60,lista_memoria)    
    print("\n lista 7: ", lista_memoria)   
    
    desaloca("P2", lista_memoria) 
    print("\n lista 8: ", lista_memoria)    
    
    desaloca("P4", lista_memoria) 
    print("\n lista 9: ", lista_memoria)     
    
    desaloca("P3", lista_memoria) 
    print("\n lista 10: ", lista_memoria)   
    ...
    #        aloca_first_fit(nome_processo, int(tamanho_processo) ,lista_memoria)    
